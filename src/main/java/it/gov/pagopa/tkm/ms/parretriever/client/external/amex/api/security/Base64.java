...
public class Base64 {
    ...
    public static byte[] encodeBytesToBytes(byte[] source, int off, int len, int options) throws java.io.IOException {
        ...
        if ((options & GZIP) != 0) {
            ...
            GZIPOutputStream gzos = new java.util.zip.GZIPOutputStream(b64os)) {
    ...
    private static int decode4to3(
        ...
        if (2 >= destination.length) {
            throw new IllegalArgumentException(String.format(
                    "Destination array with length %d cannot have offset of %d and still store three bytes.", destination.length, 0));
        }   // end if
    ...
    public static class OutputStream extends java.io.FilterOutputStream {
         ...
         */
        @Override
        public void write(@NotNull byte[] theBytes, int off, int len)
                throws java.io.IOException {
            // Encoding suspended?
            if (suspendEncoding) {
