...
public class EncryptionUtils {
    ...
    public static PrivateKey loadDecryptionKey(String fileAsString) throws GeneralSecurityException {
        return readPkcs1PrivateKey(EncodingUtils.base64Decode(fileAsString.replace(PKCS_1_PEM_HEADER,
    ...
    private static PrivateKey readPkcs1PrivateKey(byte[] pkcs1Bytes) throws GeneralSecurityException {
        ...
        return readPkcs8PrivateKey(join(new byte[]{48, -126, (byte) (totalLength >> 8 & 255),
                (byte) (totalLength & 255), 2, 1, 0, 48, 13, 6, 9, 42, -122, 72, -122, -9, 13, 1, 1, 1, 5, 0, 4, -126,
                (byte) (pkcs1Length >> 8 & 255), (byte) (pkcs1Length & 255)}, pkcs1Bytes));
    }
