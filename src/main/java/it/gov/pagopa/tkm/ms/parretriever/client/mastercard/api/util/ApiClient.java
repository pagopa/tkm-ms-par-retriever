...
import it.gov.pagopa.tkm.ms.parretriever.client.mastercard.api.auth.Authentication;
import it.gov.pagopa.tkm.ms.parretriever.client.mastercard.api.auth.HttpBasicAuth;
import it.gov.pagopa.tkm.ms.parretriever.client.mastercard.api.auth.ApiKeyAuth;

public class ApiClient {

    private String basePath = "https://api.mastercard.com/par/paymentaccountreference/1/0";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.mastercard.com/par/paymentaccountreference/1/0
